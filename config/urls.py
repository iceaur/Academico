...
urlpatterns = [
    ...
    path('disciplinas/', DisciplinaView.as_view(), name='disciplinas'),               # RF07
    ...
    path('turnos/', TurnoView.as_view(), name='turnos'),                              # RF11
    ...
    path('delete_pessoa/<int:id>/', DeletePessoaView.as_view(), name='delete_pessoa'),  # URL para excluir pessoa
